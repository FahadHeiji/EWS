...
//     mainElement.style.background = `#ffff${i < 10 || i === 100 ? i + 10: i}`
//     // Append text To Heading
//     heading.appendChild(headingText);
//     // Append text To Description
//     description.appendChild(descriptionText);

//     // Append Heading & Description To mainElement
//     mainElement.appendChild(heading);
//     mainElement.appendChild(description);

//     // Append mainElement To Body
//     document.body.appendChild(mainElement);

// }

// let userInput = document.querySelector('[name="User-Name"]');
// let ageInput = document.querySelector('[name="User-Age"]');
...
//     if (userInput !== "" && userInput.ariaValueMax.length <= 10) {
//         userValidate = true;
//         console.log("Done");
//     }
...
//     if (userValidate === false || ageValidate === flase) {
//         e.preventDefault();
//     }
// };
