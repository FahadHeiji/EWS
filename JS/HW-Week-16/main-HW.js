...
// Write Your Destructuring Assignment Here
[a, b, c] = arr1.concat(arr2, arr3).filter((e) => e.includes("Sh") || e.includes("Ma") || e.includes("Ah")).sort().reverse();
...
[o, a] = Object.getOwnPropertyNames(r);
[u, j] = r["Oath In Felghana"];
({ US: u_price, JAP: j_price } = r["Ark Of Napishtim"]);
({Origin: or} = r);
